...
// }
//
// func (m *MetricsCollectorAzureRmIam) collectPrincipals(subscription *armsubscriptions.Subscription, logger *log.Entry, callback chan<- func(), principalIdList []string) {
